...
namespace AgendaUNAPEC.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Email,Telefono")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Email,Telefono")] Contacto contacto)
        {
            if (id != contacto.Id)
            {
                return NotFound();
